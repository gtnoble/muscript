...
electric_piano_1 {
  # Intro (8)
  V1: @mp :legato REPEAT_MEASURE(1, `COMP_LOOP_A');
  V1: @mp :tenuto REPEAT_MEASURE(1, `COMP_LOOP_A');

  # A1 (16)
  V1: @mf :tenuto REPEAT_MEASURE(2, `COMP_LOOP_A');

  # A2 (16)
  V1: @mf :legato REPEAT_MEASURE(2, `COMP_LOOP_A');

  # Bridge (8)
  V1: @mp REPEAT_MEASURE(1, `COMP_LOOP_A');
...
bass {
  ...
  V1: REPEAT_MEASURE(1, `BASS_LOOP_A');

  # A1 (16)
  V1: @mf REPEAT_MEASURE(2, `BASS_LOOP_A');

  # A2 (16)
  V1: @mf REPEAT_MEASURE(2, `BASS_LOOP_A');

  # Bridge (8)
  V1: @mp REPEAT_MEASURE(1, `BASS_LOOP_A');
...
drums {
  ...
  V1: @mp REPEAT_MEASURE(4, `KICK_A');
  V2: @p r/1 | r/1 | r/1 | r/1;
  V2: @mp REPEAT_MEASURE(4, `SN_BACK');
  V3: @p REPEAT_MEASURE(4, `HAT_SW');
  V3: @mp REPEAT_MEASURE(3, `HAT_SW') | HAT_SW_O;

  # A1 (16)
  V1: @mp REPEAT_MEASURE(8, `KICK_A') | REPEAT_MEASURE(8, `KICK_B');
  V2: @mp REPEAT_MEASURE(8, `SN_BACK') | REPEAT_MEASURE(8, `SN_GHOST');
  V3: @mp REPEAT_MEASURE(15, `RIDE_SW') | RIDE_SW;

  # A2 (16)
  V1: @mf REPEAT_MEASURE(15, `KICK_B') | KICK_FILL;
  V2: @mf REPEAT_MEASURE(16, `SN_GHOST');
  V3: @mf REPEAT_MEASURE(16, `RIDE_SW');

  # Bridge (8)
  V1: @mp REPEAT_MEASURE(8, `KICK_A');
  V2: @mp REPEAT_MEASURE(8, `SN_BACK');
  V3: @mp REPEAT_MEASURE(8, `RIDE_SW');

  # Outro (8)
  V1: @mf REPEAT_MEASURE(7, `KICK_A') | KICK_FILL;
  V2: @mf REPEAT_MEASURE(8, `SN_BACK');
  V3: @diminuendo REPEAT_MEASURE(7, `HAT_SW') | r/1;
}
