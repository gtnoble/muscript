...
(time 4 4);
drums {
  V1: REPEAT_MEASURE(4, `ROCK_KICK');
  V2: REPEAT_MEASURE(4, `ROCK_SNARE');
  V3: REPEAT_MEASURE(4, `ROCK_HAT');
}

# Section 2: Four-on-the-Floor (Disco/House)
drums {
  V1: REPEAT_MEASURE(4, `FLOOR_KICK');
  V2: REPEAT_MEASURE(4, `FLOOR_SNARE');
  V3: REPEAT_MEASURE(4, `ROCK_HAT');
}

# Section 3: Funk Pattern with Ghost Notes
drums {
  V1: REPEAT_MEASURE(2, `BREAK_KICK');
  V2: @mf REPEAT_MEASURE(2, `BREAK_SNARE');
